...
func NewIoTDeviceService(iotDeviceRepo repository.IoTDeviceRepository, helper utils.Helper) proto_iot_device.IoTDeviceServiceServer {
	iotDeviceUsecase := iot_device.NewIoTDeviceUsecase(iotDeviceRepo, helper)
