...
├── device-service.go          # Main Production Service implementation
...
import (
	"device-service/domain/usecase/harvest_record"
	"device-service/domain/usecase/pest_disease_record"
	pb "device-service/proto_generated"
)
